...
def plot_position(data,namefile) -> None :
    ...
    d = data["posx"].values
    axs[0].plot( d,label="opti",c="red",linestyle=':')
    axs[0].plot( data["posx_filter"].values, label="pos_filter",c="blue")
    ...
    d = data["posy"].values
    axs[1].plot( d,label="opti",c="red",linestyle=':')
    axs[1].plot( data["posy_filter"].values, label="pos_filter",c="blue")
    ...
    d = data["posz"].values
    axs[2].plot( d,label="opti",c="red",linestyle=':')
    axs[2].plot( data["posz_filter"].values, label="pos_filter",c="blue")
...
def plot_path(data,namefile) -> None :
    ...
    plt.figure()  # Adjust the values as needed for width and height of each subplot
