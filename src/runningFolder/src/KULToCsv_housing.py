...
class PoseStampedSubscriber:
    def __init__(self,nameTarget):
        ...
        rospy.init_node('housing_to_csv', anonymous=True)

        # Subscribe to the topic /vrpn/target1 with message type PoseStamped
        self.subscriber = rospy.Subscriber("/vrpn_client_node/KUL_Housing/pose", PoseStamped, self.pose_stamped_callback)
    ...
    def save_mean_pose_to_csv(self, mean_pose):
        nameCSV = "../data/KUL/" + self.nameTarget + ".csv"
